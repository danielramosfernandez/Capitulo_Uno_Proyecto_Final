...
$mensaje_compra = "";
//^Se realiza una consulta para revisar el carrito del usuario
...
if($res->num_rows === 0){
  ...
  //^En caso de que tenga contenido
    $carrito = $res->fetch_assoc();
    $id_carrito = $carrito['id_carrito'];
  //^Se selecciona los libros que tenga introducidos en el carrito
    ...
    $productos = [];
    $total = 0;
    //^Se calcula el precio final dependiendo de la cantidad
...
//^Una vez se completa la compra es decir se hace ceckout se inserta en compras la informacion de dichos libros
...
//^Y acontinuación se vacia el carrito
